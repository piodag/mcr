...
## Copyright (C) 2020 Dr Giorgio Pioda (slight modification to add M-Deming)
##
                        ...
                        cimeth, error.ratio, alpha=0.05, weight=rep(1,nrow(wdata)))
{
    ...
    stopifnot(is.element(regmeth,c("LinReg","WLinReg","Deming","BaPa","WDeming", "MDeming","MMDeming","PaBaLarge")))
