...
## Copyright (C) 2020 Giorgio Pioda for the M and MM Deming update
##
...
#' @param method.reg regression method.  It is possible to choose between six regression methods:
...
#' @author Ekaterina Manuilova \email{ekaterina.manuilova@@roche.com}, Andre Schuetzenmeister \email{andre.schuetzenmeister@@roche.com}, Fabian Model \email{fabian.model@@roche.com}, Giorgio Pioda \email{gfwp@@ticino.com}
#' @examples
#' library("mcr")
...
mcreg <- function(x,y=NULL,error.ratio=1,alpha=0.05,
              ...
              mtest.name = NULL,
              sample.names = NULL,
              method.reg=c("PaBa","LinReg","WLinReg","Deming","WDeming","MDeming", "MMDeming", "PaBaLarge"),
