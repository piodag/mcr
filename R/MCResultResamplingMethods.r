...
## Copyright (C) 2020 Giorgio Pioda for the plotBoxEllipses method
##
                                  ...
                                  weight=rep(1,nrow(wdata)))
{
    ...
    stopifnot(is.element(regmeth,c("LinReg","WLinReg","Deming","PaBa","WDeming", "MDeming", "MMDeming", "PaBaLarge")))
